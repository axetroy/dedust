...
await executeCleanupWithEvents(dsl, testDir, {
onScanStart: () => { events.scanStart = true; },
onScanDirectory: () => { events.scanDirectory = true; },
onScanComplete: () => { events.scanComplete = true; },
onFileFound: () => { events.fileFound = true; },
onFileDeleted: () => { events.fileDeleted = true; },
});
